      ...
      <header className="border-b bg-white/90 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/leaderboard" className="text-blue-600 font-medium relative">
              Leaderboard
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Celebrate the top performers across all our learning games. Compete with students nationwide and climb the
            ranks!
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Card className="max-w-2xl mx-auto bg-gradient-to-r from-blue-50 to-orange-50 border-blue-200 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2">
            <CardContent className="pt-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Join the Champions?</h3>
              <p className="text-gray-600 mb-6">
                Start playing our educational games and see your name climb up the leaderboard!
              </p>
