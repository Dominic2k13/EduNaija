...
const scienceQuestions: ScienceQuestion[] = [
  {
    ...
    difficulty: "Easy",
    explanation:
      "Water is composed of two hydrogen atoms and one oxygen atom, hence H₂O.",
  },
  {
    id: 2,
    ...
    difficulty: "Medium",
    explanation:
      "Gravitational force between the sun and planets keeps them in orbital motion.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    difficulty: "Medium",
    explanation:
      "Type O blood has no A or B antigens, making it compatible with all blood types.",
  },
  {
    id: 7,
  ...
  },
  {
    ...
    difficulty: "Easy",
    explanation:
      "A neutral solution has a pH of 7, indicating equal concentrations of H⁺ and OH⁻ ions.",
  },
  {
    id: 14,
    question:
...
export default function ScienceExplorerGame() {
  ...
  const saveGameResult = () => {
    ...
    const gameData = {
      ...
      correctAnswers:
        answers.filter(
          (answer, index) => answer === scienceQuestions[index].correctAnswer
        ).length +
        (selectedAnswer === scienceQuestions[currentQuestion].correctAnswer
          ? 1
          : 0),
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Explore the fascinating world of Physics, Chemistry, and Biology
            ...
            <Card className="mb-8">
              ...
              <CardContent className="text-left space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    Answer {scienceQuestions.length} science questions from
        ...
        <Card className="max-w-2xl mx-auto">
          <CardContent className="pt-6 text-center">
            ...
            <div className="text-lg mb-4">
              ...
              {
                scienceQuestions[currentQuestion].options[
                  scienceQuestions[currentQuestion].correctAnswer
                ]
              }
            </div>
            ...
            <Card className="mb-8">
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-600">
                      {Math.round(
                        (correctAnswers / scienceQuestions.length) * 100
                      )}
                      %
                    </div>
                ...
                <div className="space-y-2">
                  {score >= 400 && (
                    <Badge className="bg-purple-500">Science Genius!</Badge>
                  )}
                  {score >= 300 && score < 400 && (
                    <Badge className="bg-blue-500">Excellent Explorer!</Badge>
                  )}
                  {score >= 200 && score < 300 && (
                    <Badge className="bg-green-500">Good Scientist!</Badge>
                  )}
                  {score < 200 && (
                    <Badge variant="secondary">Keep Exploring!</Badge>
                  )}
                </div>
              </CardContent>
            </Card>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="outline">
                    {scienceQuestions[currentQuestion].subject}
                  </Badge>
                  <Badge
                    variant={
                      scienceQuestions[currentQuestion].difficulty === "Easy"
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span
                    className={`text-2xl font-bold ${
                      timeLeft <= 20 ? "text-red-500" : "text-gray-900"
                    }`}
                  >
                    {timeLeft}s
                  </span>
            ...
            <Progress
              value={(currentQuestion / scienceQuestions.length) * 100}
              className="mb-4"
            />
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="grid gap-3">
                {scienceQuestions[currentQuestion].options.map(
                  (option, index) => (
                    <Button
                      key={index}
          ...
          <div className="text-center">
            <Button
              ...
              className="bg-purple-600 hover:bg-purple-700"
            >
              {currentQuestion + 1 === scienceQuestions.length
                ? "Finish Quest"
                : "Next Question"}
